...
public class GameRoom : MonoBehaviour {
	...
	{   GameObject battleRoom = transform.GetChild(7).gameObject;
		...
		if (room.IsConnectedTo(room.GetLeft()))
		{
			...
			doorWest.transform.GetChild(3).gameObject.SetActive(false);
		}
		else
		{
			...
			doorWest.transform.GetChild(3).gameObject.SetActive(true);
		}
		if (room.IsConnectedTo(room.GetRight()))
		{
			...
			doorEast.transform.GetChild(3).gameObject.SetActive(false);
		}
		else
		{
			...
			doorEast.transform.GetChild(3).gameObject.SetActive(true);
		}
		if (room.IsConnectedTo(room.GetTop()))
		{
			...
			doorNorth.transform.GetChild(3).gameObject.SetActive(false);
		}
		else
		{
			...
			doorNorth.transform.GetChild(3).gameObject.SetActive(true);
		}
		if (room.IsConnectedTo(room.GetBottom()))
		{
			...
			doorSouth.transform.GetChild(3).gameObject.SetActive(false);
		}
		else
		{
			...
			doorSouth.transform.GetChild(3).gameObject.SetActive(true);
		}
		setupRoom();
	}
